...
import com.paymentology.dxp.issuerpay.sample.ui.PaymentNetwork
...
object RandomPanBuilder {
    ...
    fun getRandomPanForNetwork(paymentNetwork: PaymentNetwork): String {
        return when (paymentNetwork) {
            PaymentNetwork.Mastercard -> generateRandomPanForMastercard()
            PaymentNetwork.Visa -> generateRandomPanForVisa()
        }
    }
